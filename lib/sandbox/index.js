...
Sandbox.prototype.runInJsEval = function (engine, timeout, code, hollaback, object) {
    ...
    // PATCH(wm-ecmabot): Use `return` and `eval` so that code can be written
    // in the same way as one would in the browser console or Node.js REPL,
    // in other words, the last statement's value is returned.
    // Test case: `>>> var a = 5; a`
    // --2018-05-25, Krinkle
    code = '(function () { return eval(' + JSON.stringify(code) + '); }.call(global))';
